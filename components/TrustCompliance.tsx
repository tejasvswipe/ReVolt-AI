const trustItems = [
  {
    ...
    span: "md:col-span-7",
    label: "Certification",
    title:  "Designed around NIST 800-88 guidelines",
    body: "Information security controls are being mapped to asset disposition workflows, structured for future SOC and ISO audit readiness.",
    emphasis: true,
  ...
  },
  {
    ...
    span: "md:col-span-5",
    label: "Wipe standard",
    title: "NIST 800-88 Rev. 1 compliant wiping strategies used",
  ...
  
  {
    ...
    title: "Built with respect to DPDP Act obligations ",
  ...
  },
  {
    ...
    span: "md:col-span-4",
    label: "Audit package",
    title: "Planned: 7-year retention option",
  ...
  
  {
    ...
    span: "md:col-span-6",
    label: "Documentation",
    title: "Designed for a full chain-of-custody record",
